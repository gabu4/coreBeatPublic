...
$MODULEBODY = "
	...
	<h1 class='title'>Bejegyzés létrehozás/szerkeszés</h1>
	<hr class='title' />
	<div class='pageContent'>
	
		<form name='form_postedit' action='' method='POST'>
			<p><span class='inpText'>Bejegyzés címe</span><input type='text' name='name' value='{#NAME}' /></p>
			<p><span class='inpText'>Bejegyzés kategória</span>{#CATEGORYLIST}</p>
			<p><span class='inpText'>Tartalom</span><textarea id='editorarea' class='contentEdit' name='text' />{#TEXT}</textarea></p>
			...
			<p><input type='submit' name='adminPageEditSave' value='Mentés' /></p>
		</form>
