...
function articleCreateJS() {
    if ( jQuery('select.articleSelect').length > 0 ) {
        if ( jQuery('select.articleSelect>option').length > 0 ) {
            jQuery('select.articleSelect>option').on("dblclick",function() {
    ...
    if ( jQuery('select.languageSelect').length > 0 ) {
        if ( jQuery('select.languageSelect>option').length > 0 ) {
            jQuery('select.languageSelect>option').on("click",function() {
                ...
                jQuery('.articleSelect').attr('disabled',true).hide();
                jQuery('.articleSelect_'+lang).attr('disabled',false).removeClass('hidden').show();
