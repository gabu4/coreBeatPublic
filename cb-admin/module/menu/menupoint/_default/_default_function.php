...
class funct extends database {
    ...
    protected function menupointHtml_themeLoad($data, $id = 0) {
        ...
        $html = $theme->loadAdminTemplate2('menu_menupoint_default', FALSE, 'menu');
        ...
        $replace['title'] = ( isset($data['name']) ) ? '[LANG_ADMIN_MENU_MENUPOINT_'.strtoupper($type).'_EDIT_TITLE]' : '[LANG_ADMIN_MENU_MENUPOINT_'.strtoupper($type).'_CREATE_TITLE]';
        ...
        $replace['id'] = $id;
        $replace['content_id'] = $data['content_id'];
